        ...
        <form class="form-horizontal" action ='' method='POST'>
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="username" name="username" type="text" value="<?php echo set_value('username'); ?>" placeholder="Tên đăng nhập" class="form-control input-md" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="password" name="password" type="password" placeholder="Mật khẩu" class="form-control input-md" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <button id="login" name="login" class="btn btn-block btn-primary">Đăng nhập</button>
                        <div id="ack"></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-5">
                            <a href='<?php echo base_url(); ?>signup'> Đăng ký </a>
                        </div>
                    </div>
                    </div>
                <div class="form-group">
